...
```bash
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/YOUR_USERNAME/cmd-learn/main/install.sh)"
```
...
```bash
git clone https://github.com/YOUR_USERNAME/cmd-learn.git ~/.cmd-learn
~/.cmd-learn/cmd-learn
```
