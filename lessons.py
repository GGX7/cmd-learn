"""教科書モードのレッスンデータ（全カテゴリ）"""

# 各レッスンのフィールド:
#   id, category, command, title, description, syntax,
#   options: list[(フラグ, 説明)]
#   examples: list[{cmd, desc, note, runnable, cwd}]
#     cwd: "sandbox" = サンドボックスディレクトリ内で実行 / None = 現在のシェルで実行
...
LESSONS: list[dict] = [
    ...
    # ──────────────────────────────────────────────────────────
    {
        ...
        "examples": [
            {
                "cmd": "ls",
                "desc": "カレントディレクトリの内容を表示",
                "note": "ファイルとディレクトリが並んで表示されます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "ls -la",
                "desc": "隠しファイルも含めて詳細情報を表示",
                "note": "先頭が . のファイルも表示されます。左端の drwxr-xr-x は権限情報です。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "ls -lh docs",
                "desc": "docs ディレクトリの詳細をサイズ付きで表示",
                "note": "パスを指定すると、そのディレクトリの内容を確認できます。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
    {
        ...
        "examples": [
            {
                "cmd": "pwd",
                "desc": "現在のディレクトリ（絶対パス）を表示",
                "note": "/home/ユーザー名 や /Users/ユーザー名 の形式で表示されます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "cd /tmp && pwd",
                "desc": "/tmp ディレクトリに移動して現在地を確認",
                "note": "&& は「前のコマンドが成功したら次を実行」する記号です。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "cd ~ && pwd",
                "desc": "ホームディレクトリに移動",
                "note": "~ はログイン中のユーザーのホームディレクトリを指します。",
                "runnable": True, "cwd": None,
            },
        ],
    },
    {
        "id": "lesson_mkdir_touch",
        "category": "file",
        "command": "mkdir / touch",
        ...
        "examples": [
            {
                "cmd": "mkdir myproject && ls",
                "desc": "myproject ディレクトリを作成して確認",
                "note": "ls で新しいディレクトリが増えていることを確認できます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "mkdir -p myproject/src/utils && ls myproject/src",
                "desc": "-p で階層ディレクトリを一括作成",
                "note": "深い階層も一度に作れます。-p を付けるとエラーにもなりません。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "touch myproject/README.md && ls myproject",
                "desc": "README.md を作成してディレクトリ内容を確認",
                "note": "touch で中身が空のファイルが作成されました。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
    {
        ...
        "examples": [
            {
                "cmd": "cp hello.txt hello_backup.txt && ls",
                "desc": "hello.txt を hello_backup.txt にコピー",
                "note": "元のファイルはそのまま残り、コピーが作成されます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "mv hello_backup.txt docs/hello_backup.txt && ls docs",
                "desc": "hello_backup.txt を docs ディレクトリに移動",
                "note": "mv はカット＆ペーストに相当します。元の場所のファイルはなくなります。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "mv docs/hello_backup.txt docs/renamed.txt && ls docs",
                "desc": "ファイル名を renamed.txt に変更",
                "note": "同じディレクトリ内の mv は名前変更になります。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
    {
        ...
        "examples": [
            {
                "cmd": "touch trash.txt && ls",
                "desc": "削除用のテストファイルを作成して確認",
                "note": "まず削除するファイルを用意します。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "rm trash.txt && ls",
                "desc": "trash.txt を削除して結果を確認",
                "note": "ファイルが消えました。ゴミ箱には入りません！",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "mkdir tempdir && touch tempdir/a.txt tempdir/b.txt && rm -r tempdir && ls",
                "desc": "ディレクトリを中身ごと削除",
                "note": "-r（recursive）なしではディレクトリは削除できません。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
    {
        ...
        "examples": [
            {
                "cmd": "find . -name '*.txt'",
                "desc": "カレントディレクトリ以下の .txt ファイルをすべて検索",
                "note": ". は「現在のディレクトリ」です。サブディレクトリも自動で検索されます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "find . -type d",
                "desc": "ディレクトリだけを検索",
                "note": "-type d でディレクトリのみが表示されます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "find . -name '*.txt' -type f",
                "desc": "条件を組み合わせて .txt ファイルのみ検索",
                "note": "複数の条件は AND で組み合わせられます。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
    ...
    # ──────────────────────────────────────────────────────────
    {
        ...
        "examples": [
            {
                "cmd": "cat hello.txt",
                "desc": "hello.txt の全内容を表示",
                "note": "短いファイルは cat が便利。長いファイルは less を使いましょう。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "cat -n log.txt",
                "desc": "行番号付きで log.txt を表示",
                "note": "-n で行番号が付き、エラーの位置特定などに役立ちます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "head -n 3 log.txt",
                "desc": "log.txt の先頭3行を表示",
                "note": "大きなファイルの先頭だけを素早く確認できます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "tail -n 3 log.txt",
                "desc": "log.txt の末尾3行を表示",
                "note": "ログファイルは末尾に最新情報があるので tail をよく使います。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
        ...
        "examples": [
            {
                ...
                "desc": "log.txt から ERROR を含む行を表示",
                "note": "大文字小文字は区別されます。-i を付けると error も対象になります。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "grep -n INFO log.txt",
                "desc": "INFO を含む行を行番号付きで表示",
                "note": "-n で何行目に書かれているか分かり、調査が効率的になります。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "grep -c ERROR log.txt",
                "desc": "ERROR を含む行数だけを表示",
                "note": "-c は count の略。エラー件数の集計などに使えます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "grep -r txt .",
                "desc": "現在のディレクトリ以下すべてから txt を含む行を検索",
                "note": "-r でサブディレクトリも対象になります。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
    {
        ...
        "examples": [
            {
                "cmd": "wc -l log.txt",
                "desc": "log.txt の行数を数える",
                "note": "wc -l はログの件数確認によく使います。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "sort numbers.txt",
                "desc": "numbers.txt を文字列順で並べ替え",
                "note": "デフォルトは文字列順なので 10 < 2 になる点に注意！",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "sort -n numbers.txt",
                "desc": "数値として正しく並べ替え",
                "note": "-n で 1, 2, 3... の正しい数値順になります。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "sort numbers.txt | uniq",
                "desc": "並べ替えてから重複行を除去",
                "note": "| はパイプ。前のコマンドの出力を次のコマンドに渡します。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
    {
        ...
        "examples": [
            {
                "cmd": "sed 's/INFO/情報/' log.txt",
                "desc": "各行の最初の INFO を 情報 に置換して表示",
                "note": "ファイル自体は変更されません。置換結果が標準出力に表示されます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "sed 's/ERROR/エラー/g' log.txt",
                "desc": "各行のすべての ERROR をエラーに置換",
                "note": "g フラグで行内のすべての一致が置換されます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "sed -n '2,3p' log.txt",
                "desc": "2〜3行目だけを表示",
                "note": "-n で出力を抑制し、p で特定の行だけ表示できます。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
        ...
        "examples": [
            {
                ...
                "desc": "ERROR を含む行数をカウント（grep + wc のパイプ）",
                "note": "grep の出力が wc の入力になります。これがパイプの仕組みです。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "sort numbers.txt | uniq | wc -l",
                "desc": "数値ファイルの重複除去後の行数を確認",
                "note": "3つのコマンドをつないで複雑な処理が一行で書けます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "echo '追記テキスト' >> hello.txt && cat hello.txt",
                "desc": "hello.txt にテキストを追記して確認",
                "note": ">> で追記、> で上書きです。> は既存の内容が消えるので注意！",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
    ...
    # ──────────────────────────────────────────────────────────
    {
        ...
        "examples": [
            {
                "cmd": "ps",
                "desc": "現在のシェルに関連するプロセスを表示",
                "note": "PID（プロセスID）・TTY（端末）・TIME（CPU時間）・CMD（コマンド名）が表示されます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "ps aux | head -10",
                "desc": "全プロセスを詳細表示（先頭10件）",
                "note": "%CPU と %MEM でリソース使用率が分かります。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "ps aux | grep python",
                "desc": "python という名前のプロセスを検索",
                "note": "特定のプロセスが動いているか確認したいときは grep と組み合わせます。",
                "runnable": True, "cwd": None,
            },
        ],
    },
    {
        ...
        "examples": [
            {
                "cmd": "kill -l | head -5",
                "desc": "利用可能なシグナルの一覧（先頭5件）",
                "note": "SIGTERM=15（終了要求）と SIGKILL=9（強制終了）が最もよく使われます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "sleep 120 & PID=$! && echo \"起動 PID=$PID\" && kill $PID && echo \"終了しました\"",
                "desc": "sleep プロセスを起動して即座に終了させる",
                "note": "$! は直前にバックグラウンド起動したプロセスのPIDです。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "ps aux | grep sleep",
                "desc": "sleep という名前のプロセスを検索して確認",
                "note": "先ほど kill したので sleep プロセスが存在しないことが確認できます。",
                "runnable": True, "cwd": None,
            },
        ],
    },
    {
        ...
        "examples": [
            {
                "cmd": "sleep 30 & sleep 30 & jobs",
                "desc": "2つのバックグラウンドジョブを起動して一覧表示",
                "note": "[ ] 内の数字がジョブ番号です。fg %1 で1番目をフォアグラウンドにできます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "jobs | wc -l",
                "desc": "現在のバックグラウンドジョブ数を確認",
                "note": "ジョブが0件のときは何も表示されません。",
                "runnable": True, "cwd": None,
            },
        ],
    },
        ...
        "examples": [
            {
                ...
                "desc": "自分自身（localhost）への疎通確認（3回）",
                "note": "localhost（127.0.0.1）は常に応答します。time= が応答時間（ms）です。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "ping -c 2 8.8.8.8",
                "desc": "Google の DNS サーバー（8.8.8.8）への疎通確認",
                "note": "インターネット接続がある場合に応答が返ります。",
                "runnable": True, "cwd": None,
            },
        ],
    },
        ...
        "examples": [
            {
                ...
                "desc": "example.com の HTTP レスポンスヘッダーを確認",
                "note": "HTTP/1.1 200 OK などのステータスコードとヘッダーが表示されます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "curl -s https://httpbin.org/ip",
                "desc": "自分のパブリック IP アドレスを確認",
                "note": "httpbin.org は HTTP のテスト用公開サービスです。-s で進捗を非表示にします。",
                "runnable": True, "cwd": None,
            },
        ],
    },
        ...
        "examples": [
            {
                ...
                "desc": "google.com の IP アドレスを DNS で確認",
                "note": "Server が DNS サーバー、Address がドメインに紐づく IP アドレスです。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "nslookup 8.8.8.8",
                "desc": "IP アドレスからドメイン名を逆引き",
                "note": "逆引き DNS が設定されていればドメイン名が表示されます。",
                "runnable": True, "cwd": None,
            },
        ],
    },
        ...
        "examples": [
            {
                ...
                "note": "ls -la で l (link) と -> hello.txt が表示されます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "cat link_to_hello",
                "desc": "リンク経由でファイルを読み込む",
                "note": "シンボリックリンクを通じて元ファイルの内容を参照できます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "readlink link_to_hello",
                "desc": "シンボリックリンクの参照先を確認",
                "note": "readlink でリンクが指すパスを確認できます。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
    {
        "id": "lesson_chmod_chown",
        "category": "file",
        "command": "chmod / chown",
        ...
        "examples": [
            {
                "cmd": "ls -l hello.txt",
                "desc": "現在のパーミッションを確認",
                "note": "-rw-r--r-- の形式で表示されます。先頭の - はファイル（d はディレクトリ）です。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "chmod 755 hello.txt && ls -l hello.txt",
                "desc": "パーミッションを 755（rwxr-xr-x）に変更",
                "note": "7=rwx, 5=r-x。オーナーが全権限、グループとその他が読み取り+実行になります。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "chmod +x hello.txt && ls -l hello.txt",
                "desc": "実行権限を追加（記号表記）",
                "note": "+x で全員に実行権限を追加します。u+x でオーナーのみ、g-w でグループの書き込みを削除などもできます。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
    {
        ...
        "options": [
            ...
            ("tar -xzf -C dir/", "指定ディレクトリに展開する"),
        ],
        "examples": [
            {
                "cmd": "tar -czf docs_backup.tar.gz docs/ && ls -lh docs_backup.tar.gz",
                "desc": "docs/ ディレクトリを tar.gz に圧縮",
                "note": "c=create, z=gzip圧縮, f=ファイル名指定。元のディレクトリはそのまま残ります。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "tar -tzf docs_backup.tar.gz",
                "desc": "アーカイブの中身を一覧表示（展開しない）",
                "note": "t=list。展開前に中身を確認するのが安全です。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "tar -xzf docs_backup.tar.gz -C /tmp/ && ls /tmp/docs",
                "desc": "/tmp に展開して確認",
                "note": "-C で展開先ディレクトリを指定します。カレントに展開する場合は -C を省略します。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "gzip -k hello.txt && ls -lh hello.txt hello.txt.gz",
                "desc": "hello.txt を gzip 圧縮（元ファイルを残す）",
                "note": "-k（keep）で元ファイルを残します。通常 gzip は元ファイルを削除します。gunzip で解凍できます。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
        ...
        "examples": [
            {
                ...
                "desc": "2つのファイルの差分を表示",
                "note": "< が f1 のみの行、> が f2 のみの行です。変更箇所の前後数行も表示されます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "diff -u /tmp/f1.txt /tmp/f2.txt",
                "desc": "unified 形式で差分を表示",
                "note": "- が削除行、+ が追加行です。git diff もこの形式を使っています。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "stat hello.txt",
                "desc": "hello.txt のメタデータを詳しく確認",
                "note": "Access/Modify/Change の3つの時刻の違いに注目です。Modify はデータ更新、Change はメタデータ（権限など）更新時刻です。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "file hello.txt src/main.py /bin/ls",
                "desc": "複数ファイルの種類を一括判定",
                "note": "テキストファイル・Pythonスクリプト・実行バイナリの違いが確認できます。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
    ...
    # ══════════════════════════════════════════════════════════
    {
        ...
        "examples": [
            {
                "cmd": "awk -F',' '{print $1}' data.csv",
                "desc": "CSV の1列目（name）を表示",
                "note": "-F',' でカンマを区切り文字に指定します。$1 が最初のフィールドです。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "awk -F',' 'NR>1 {print $1, $3}' data.csv",
                "desc": "ヘッダー行をスキップして name と city を表示",
                "note": "NR>1 で2行目以降を対象にします。複数フィールドはスペース区切りで並べます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "awk -F',' 'NR>1 {sum+=$2} END{print \"平均年齢:\", sum/(NR-1)}' data.csv",
                "desc": "CSV の age 列の平均値を計算",
                "note": "END ブロックは全行処理後に実行されます。NR-1 でヘッダー分を引いています。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "awk '{print NR\": \"$0}' log.txt",
                "desc": "ログファイルに行番号を付けて表示",
                "note": "NR は行番号です。cat -n と同様の効果ですが、awk でより柔軟な加工ができます。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
    {
        ...
        "examples": [
            {
                "cmd": "cut -d',' -f1,3 data.csv",
                "desc": "CSV から name と city の列を抽出",
                "note": "-f1,3 で1番目と3番目のフィールドを抽出します。-f1-3 で1〜3番目の範囲指定もできます。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "echo 'Hello World' | tr 'a-z' 'A-Z'",
                "desc": "小文字を大文字に変換",
                "note": "tr は文字の1対1変換を行います。シンプルな変換には sed より簡単です。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "cat numbers.txt | tr '\\n' ',' | sed 's/,$/\\n/'",
                "desc": "複数行の数値をカンマ区切りの1行にまとめる",
                "note": "tr -d '\\n' で改行を削除→カンマに変換する定番パターンです。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "paste numbers.txt numbers.txt",
                "desc": "同じファイルを2列に並べて表示",
                "note": "paste はファイルを横方向に結合します。2つの別ファイルを横並びにしたいときに使います。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
    {
        ...
        "options": [
            ...
            ("tee -a",      "ファイルに追記する（上書きでなく追記）"),
        ],
        "examples": [
            {
                "cmd": "find . -name '*.txt' | xargs wc -l",
                "desc": "全 .txt ファイルの行数を一括カウント",
                "note": "xargs は find の出力を wc -l の引数として渡します。ファイルが多いときに cat より効率的です。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "find . -name '*.py' | xargs grep -l 'def'",
                "desc": "def を含む Python ファイルを検索",
                "note": "grep -l はファイル名のみを表示します。xargs と組み合わせた一括検索の定番パターンです。",
                "runnable": True, "cwd": "sandbox",
            },
            {
                "cmd": "ls | tee filelist.txt | wc -l",
                "desc": "ls の結果をファイルに保存しながら行数を数える",
                "note": "tee でパイプラインを分岐させます。画面表示・ファイル保存・次のコマンドへの渡しを同時に実現できます。",
                "runnable": True, "cwd": "sandbox",
            },
        ],
    },
    {
        ...
        "examples": [
            {
                "cmd": "less log.txt",
                "desc": "log.txt をページャーで表示",
                "note": "q で終了、/ でテキスト検索ができます。長いファイルを確認するときの基本です。",
                "runnable": False,
                "simulated_output": (
            ...
            {
                "cmd": "ps aux | less",
                "desc": "ps aux の長い出力をページャーで見やすく表示",
    ...
    # ══════════════════════════════════════════════════════════
    {
        ...
        "examples": [
            {
                "cmd": "crontab -l",
                "desc": "現在設定されている crontab を表示",
                "note": "設定がない場合は 'no crontab for user' と表示されます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "echo '# 毎日00時に実行: 0 0 * * * /path/to/backup.sh' | cat",
                "desc": "cron 書式の例を確認（実際には crontab -e で編集）",
                "note": "分(0-59) 時(0-23) 日(1-31) 月(1-12) 曜日(0-7, 0と7は日曜)。* は毎回を意味します。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "at -l 2>/dev/null || echo 'at の待ちキューはありません'",
                "desc": "at コマンドの待ちキューを確認",
                "note": "at はインストールされていない場合があります。echo 'cmd' | at now + 1 minute でスケジュール登録できます。",
                "runnable": True, "cwd": None,
            },
        ],
    },
    {
        "id": "lesson_lsof_watch",
        "category": "process",
        ...
        "examples": [
            {
                ...
                "note": "Web サーバーが起動していれば nginx や httpd などが表示されます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "lsof /tmp 2>/dev/null | head -5",
                "desc": "/tmp を使用しているプロセスの先頭5件を表示",
                "note": "ファイルを開いているプロセスを調べるときに使います。アンマウントできない原因の調査にも有効です。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "timeout 3 sleep 10 && echo '完了' || echo 'タイムアウトしました'",
                "desc": "sleep 10 を3秒でタイムアウト",
                "note": "timeout は指定秒数を超えるとプロセスを終了させます。スクリプトで無限ループを防ぐのに使います。",
                "runnable": True, "cwd": None,
            },
        ],
    },
        ...
        "examples": [
            {
                ...
                "note": "ni 列に 19 が表示されます。CPUを大量に使うバッチ処理はこのように低優先度で実行するのが良い習慣です。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "ps -o pid,ni,comm | head -8",
                "desc": "実行中プロセスの PID・nice 値・コマンド名を表示",
                "note": "通常のプロセスは nice 値 0 です。値が大きいほど他のプロセスにCPUを譲ります。",
                "runnable": True, "cwd": None,
            },
        ],
    },
        ...
        "examples": [
            {
                ...
                "note": "inet 127.0.0.1 がループバックIPアドレスです。macOS は lo0、Linux は lo という名前です。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "ip route show 2>/dev/null || netstat -rn | head -10",
                "desc": "ルーティングテーブルを確認",
                "note": "default の行がデフォルトゲートウェイです。通常はルーターのIPアドレスが表示されます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "hostname",
                "desc": "このマシンのホスト名を確認",
                "note": "ホスト名はネットワーク上でマシンを識別する名前です。/etc/hostname ファイルに設定されています。",
                "runnable": True, "cwd": None,
            },
        ],
    },
    {
        "id": "lesson_netstat_dig",
        "category": "network",
        ...
        "options": [
            ...
            ("dig MX",        "メールサーバーレコードを確認"),
        ],
        "examples": [
            {
                "cmd": "netstat -an 2>/dev/null | head -15",
                "desc": "現在のネットワーク接続を表示（先頭15件）",
                "note": "LISTEN は待ち受け中、ESTABLISHED は接続済み、TIME_WAIT は終了待ちです。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "ss -tlnp 2>/dev/null | head -10 || netstat -tlnp 2>/dev/null | head -10",
                "desc": "LISTEN 状態の TCP ポートを確認",
                "note": "どのポートでサービスが待ち受けているか確認できます。セキュリティ確認に使います。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "dig +short google.com",
                "desc": "google.com の IP アドレスを DNS で確認",
                "note": "+short で IP アドレスだけを表示します。dig google.com A でAレコードの詳細を確認できます。",
                "runnable": True, "cwd": None,
            },
        ],
    },
        ...
        "examples": [
            {
                ...
                "note": "scp はSSHと同じ鍵・パスワード認証を使います。-r でディレクトリごとコピーできます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "rsync -av --dry-run /tmp/cmd_learn_sandbox/ /tmp/rsync_test/",
                "desc": "rsync のドライラン（実際には転送しない確認）",
                "note": "--dry-run (-n) で実際には転送せず、どのファイルが同期されるかだけ表示します。本番前に必ず確認しましょう。",
                "runnable": True, "cwd": None,
            },
        ],
    },
    ...
    # ══════════════════════════════════════════════════════════
    {
        ...
        "syntax": "man コマンド\nwhich コマンド\ntype コマンド",
        "options": [
            ("man -k キーワード", "キーワードでマニュアルを検索する（apropos と同じ）"),
        ...
        "examples": [
            {
                "cmd": "which ls",
                "desc": "ls コマンドの実行ファイルのパスを確認",
                "note": "/bin/ls や /usr/bin/ls のようなパスが表示されます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "which python3 2>/dev/null || echo 'python3 が見つかりません'",
                "desc": "python3 のインストール場所を確認",
                "note": "コマンドが見つからない場合は which は何も出力しません。バージョン管理ツール（pyenv等）を使っていると別のパスが出ることがあります。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "type cd && type ls",
                "desc": "cd と ls の種類を確認",
                "note": "cd は shell builtin（シェル組み込み）、ls は /bin/ls などの外部コマンドです。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "ls --help 2>&1 | head -15",
                "desc": "ls の簡易ヘルプを確認",
                "note": "--help はほとんどのコマンドで使えます。man ページより簡潔です。",
                "runnable": True, "cwd": None,
            },
        ],
    },
        ...
        "examples": [
            {
                ...
                "desc": "よく使う環境変数を確認",
                "note": "$HOME, $USER, $SHELL, $PATH は主要な環境変数です。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "export GREETING='Hello!' && echo $GREETING",
                "desc": "新しい環境変数を設定して確認",
                "note": "export で設定した変数は子プロセスにも引き継がれます。export なしの代入は現在のシェルのみです。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "env | grep PATH",
                "desc": "PATH 環境変数の現在の値を確認",
                "note": "PATH はコロン区切りで複数のディレクトリが並んでいます。コマンドはこの順番で検索されます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "printenv SHELL",
                "desc": "現在使っているシェルを確認",
                "note": "printenv は特定の変数だけを表示します。env | grep SHELL と同じ結果です。",
                "runnable": True, "cwd": None,
            },
        ],
    },
    {
        "id": "lesson_alias_history",
        "category": "shell",
        ...
        "examples": [
            {
                "cmd": "alias",
                "desc": "現在設定されているエイリアス一覧を表示",
                "note": "OS やシェルの設定によってデフォルトのエイリアスが設定されています。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "alias ll='ls -la' && alias gs='git status' && alias",
                "desc": "よく使うエイリアスを設定して確認",
                "note": "永続化するには ~/.bashrc や ~/.zshrc に書いておきます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "history | tail -10",
                "desc": "最近の履歴を10件表示",
                "note": "左の番号で !番号 として再実行できます。Ctrl+R で過去のコマンドをインクリメンタル検索できます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "history | grep ls | tail -5",
                "desc": "ls を含む過去のコマンドを検索",
                "note": "よく使ったコマンドを探すときに便利です。特定コマンドの過去のオプションを確認するのに使えます。",
                "runnable": True, "cwd": None,
            },
        ],
    },
    {
        "id": "lesson_shell_vars",
        "category": "shell",
        "command": "変数 / クォート / グロブ",
        ...
        "examples": [
            {
                "cmd": "uname -a",
                "desc": "システムの全情報を表示",
                "note": "カーネルバージョン・ホスト名・CPU アーキテクチャが一行で確認できます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "uname -s && uname -r && uname -m",
                "desc": "OS名・カーネルバージョン・アーキテクチャを個別に表示",
                "note": "macOS は Darwin、Linux は Linux と表示されます。アーキテクチャは x86_64（Intel）や arm64（Apple Silicon/ARM）です。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "hostname",
                "desc": "このマシンのホスト名を表示",
                "note": "ホスト名はネットワーク上の識別名です。SSH接続の @ の後に使うホスト名と一致します。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "uptime",
                "desc": "システムの起動時間と負荷平均を表示",
                "note": "load average の3つの数値は1分・5分・15分の平均CPU負荷です。コア数以上の値が続く場合は過負荷です。",
                "runnable": True, "cwd": None,
            },
        ],
    },
    {
        ...
        "examples": [
            {
                "cmd": "df -h",
                "desc": "全ファイルシステムのディスク容量を確認",
                "note": "Use% が 90% を超えるとディスクフルが近いです。Mounted on がマウントポイントです。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "du -sh /tmp/cmd_learn_sandbox/*",
                "desc": "サンドボックス内の各ファイル・ディレクトリのサイズを確認",
                "note": "-s で合計のみ（サブディレクトリを展開しない）、* でカレント内の各アイテムを対象にします。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "du -sh /tmp",
                "desc": "/tmp ディレクトリ全体のディスク使用量を確認",
                "note": "ディスクを圧迫しているディレクトリを特定するには、大きなディレクトリから順に du で掘り下げます。",
                "runnable": True, "cwd": None,
            },
        ],
    },
        ...
        "examples": [
            {
                "cmd": "who",
                "desc": "ログイン中のユーザーを表示",
                "note": "ユーザー名・端末・ログイン時刻が表示されます。w コマンドはより詳細な情報を表示します。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "id",
                "desc": "現在のユーザーの UID/GID/グループを確認",
                "note": "uid=0(root) の場合は root ユーザーです。グループに sudo や wheel があると管理者権限が使えます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "date",
                "desc": "現在の日時を表示",
                "note": "システムのタイムゾーンで表示されます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "date +\"%Y-%m-%d %H:%M:%S\"",
                "desc": "日時をファイル名向けのフォーマットで表示",
                "note": "バックアップファイル名に日付を付けるときによく使います。例: backup_$(date +%Y%m%d).tar.gz",
                "runnable": True, "cwd": None,
            },
        ],
    },
    {
        ...
        "options": [
            ...
            ("sysctl vm.swappiness", "特定パラメータを確認（Linux）"),
        ],
        "examples": [
            {
                "cmd": "free -h 2>/dev/null || vm_stat | head -10",
                "desc": "メモリ使用状況を確認",
                "note": "free は Linux 専用です。macOS では vm_stat コマンドを使います。",
                "runnable": True, "cwd": None,
            },
            {
                ...
                "note": "USB デバイス接続やドライバエラーなどが表示されます。macOS では log コマンドを使います。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "sysctl -a 2>/dev/null | head -10",
                "desc": "カーネルパラメータの一覧を確認（先頭10件）",
                "note": "sysctl でカーネルの動作パラメータを確認・変更できます。macOS・Linux 両方で使えます。",
                "runnable": True, "cwd": None,
            },
            {
                "cmd": "cat /proc/meminfo 2>/dev/null | head -10 || sysctl hw.memsize 2>/dev/null",
                "desc": "物理メモリの詳細情報を確認",
                "note": "Linux は /proc/meminfo、macOS は sysctl hw.memsize でメモリ情報を確認できます。",
                "runnable": True, "cwd": None,
            },
        ],
    },
